...
isCharge: "" || false
 ...
 const rechoute = async(id, título, descripción, buffer, enlace) => {
    ...
    leo.sendMessage(id, {name: "𝕭𝖔𝖙-By Traxnox 𝕺𝕱𝕮", address: "", jpegThumbnail: fs.readFileSync('./media/imagen/Faketumber.jpg'), }, MessageType.text, opción)}
...
*Youtube:*
https://youtube.com/c/ByTraxnox
*Github:*
https://github.com/ByTraxnox2`
...
🌐 *Instagram* : ${instagram}
🌐 *Github:* ${Githu}
🌐 *Youtube:* https://youtube.com/c/ByTraxnox`
...
if (choute.message.buttonsResponseMessage){
  ...
  if (test.includes(`sex`)){
    ...
    "thumbnail": fs.readFileSync(`media/imagen/youtube-min.jpg`), 
    mediaUrl: "https://youtube.com/c/ByTraxnox"}}}) 
    addFilter(from)
...
if (test.includes(`grupo`)){
  ...
  *-Te invito a unirte al grupo de WhatsApp donde:-*
  ...
  Grupo 1 : 
  _https://chat.whatsapp.com/DtAdGLHekj48vNDXjTfN3S_
  
  Grupo 2 : 
  _https://chat.whatsapp.com/CxH42Vk0FGd7xnCIqCymWu_`, MessageType.text, {quoted: choute})
  addFilter(from)
    addLevelingLevel(sender, 5)	}}
...
if (test.includes(`nuevo`)){
  fansh = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 0, "totalAmount1000" : '1000', "message": `${nuevo}\n\n\nCreador is By Traxnox`, "footerText": "*By Traxnox*", "thumbnail": fs.readFileSync('./media/imagen/Faketumber.jpg'), "surface": 'CATALOG', "orderTitle": 'Sexo'}}, {contextInfo: { mentionedJid: [sender, ownerNumber]}, quoted:choute, })
...
its = await getBuffer (ppimg)
    ...
    "sourceUrl": 'https://www.instagram.com/bytraxnox/'}}})
      addFilter(from)  
  addLevelingLevel(sender, 5)	}}
...
if (choute.message.listResponseMessage){
  ...
  leo.updatePresence(from, Presence.composing)
  if (!isRegister) return leoply(baby.only.usrReg)
tampa = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 9999999, "message": `${reglas}`, "footerText": "*By Traxnox*", "thumbnail": fs.readFileSync('./media/imagen/imgregla.jpg'), "surface": 'CATALOG' }}, {contextInfo: { mentionedJid: [sender,ownerNumber]}, quoted:choute, })
...
if (choute.message.listResponseMessage){
  ...
  `${texto}\n${allmenu}`
    ...
    buttonsMessage = {
    contentText: `${txtt}`,
    footerText: '© Creator By Traxnox', imageMessage: imageMsg,
    buttons: buttons1,
    headerType: 4}
  ...
  if (choute.message.listResponseMessage){
    ...
    leo.updatePresence(from, Presence.composing)
    if (!isRegister) return leoply(baby.only.usrReg)    
    fansh = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 0, "totalAmount1000" : '1000', "message": `${menusticker}\n\n\nCreador is By Traxnox`, "footerText": "*By Traxnox*", "thumbnail": fs.readFileSync('./media/imagen/cosplay/25.jpg'), "surface": 'CATALOG', "orderTitle": 'Sexo'}}, {contextInfo: { mentionedJid: [sender]}, quoted:choute, })
    leo.relayWAMessage(fansh)
    addFilter(from)
    addLevelingLevel(sender, 5)	}}
...
addLevelingLevel(sender, 5)	}}
  ...
  if (choute.message.listResponseMessage){
    ...
    if (!isRegister) return leoply(baby.only.usrReg)
    uptime = process.uptime()
    fansh = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 9999999999999999999999, "totalAmount1000" : '1000', "message": `${texto}\n${entrete}`, "footerText": "*By Traxnox*", "thumbnail": fs.readFileSync('./media/imagen/izu.jpg'), "surface": 'CATALOG', "orderTitle": 'Sexo'}}, {contextInfo: { mentionedJid: [sender]}, quoted:choute, })
    leo.relayWAMessage(fansh)
    addFilter(from)
    addLevelingLevel(sender, 5)	}}
    //Logo
    ...
    if (choute.message.buttonsResponseMessage){
      ...
      if (test.includes(`hetai`)){
        ...
        bufhtz = await getBuffer(hentaiz.data.url)
          ...
          buttonsMessage = {
          contentText: `${txtt}`,
          footerText: 'By Traxnox\n© Creator By Traxnox', imageMessage: imageMsg,
          buttons: buttons1,
          headerType: 4}
          prep = leo.prepareMessageFromContent(from, { buttonsMessage }, { quoted: choute,  contextInfo: { mentionedJid: [sender,ownerNumber]} })
          leo.relayWAMessage(prep)
...
case 'sticker':
                        ...
                        "sourceUrl": 'https://chat.whatsapp.com/DtAdGLHekj48vNDXjTfN3S'}}});
                        fs.unlinkSync(media);
                        fs.unlinkSync(ran);})
...
case 'creador':
                ...
                "sourceUrl": 'https://youtube.com/c/ByTraxnox'}}})
                break  
...
leo.sendMessage('593997894792@s.whatsapp.net', options, text, {quoted: choute})
...
case 'github':
                if (isBan) return leoply  (baby.only.benned)	
                if (!isRegister) return leoply(baby.only.usrReg)	
                leo.sendMessage(from, `*Git Del Bot:*\nhttps://github.com/ByTraxnox2\n\n*Github de mi Creador:*\nhttps://github.com/ByTraxnox2`, MessageType.text, {quoted: choute, contextInfo: { mentionedJid: [sender], "forwardingScore": 508, "externalAdReply": 
                {"title": 'Github Oficial',       
                "body": 'Sigueme en Github',  
                "thumbnail": fs.readFileSync('./media/imagen/absu.jpg'),
                "sourceUrl": 'https://github.com/ByTraxnox2/bytraxnox_bot'}}})
                break
...
case 'reglas':
                if (isBan) return leoply  (baby.only.benned)	
                if (!isRegister) return leoply(baby.only.usrReg)	
                mreg = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 9999999, "message": `${reglas}`, "footerText": "*By Traxnox*", "thumbnail": fs.readFileSync('./media/imagen/imgregla.jpg'), "surface": 'CATALOG' }}, {contextInfo: { mentionedJid: [sender,ownerNumber]}, quoted:choute, })
...
case 'catalogo':
            ...
            fansh = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": `${cantidad}`, "totalAmount1000" : '1000', "message": `${name}\n\n\nCreador is By Traxnox`, "footerText": "*By Traxnox*", "thumbnail": ft, "surface": 'CATALOG', "orderTitle": 'Sexo'}}, {contextInfo: { mentionedJid: [sender]}, quoted:choute, })
            leo.relayWAMessage(fansh)
            break
...
case 'nuevo':
  fansh = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 0, "totalAmount1000" : '1000', "message": `${nuevo}\n\n\nCreador is By Traxnox`, "footerText": "*By Traxnox*", "thumbnail":  fs.readFileSync('./media/imagen/Faketumber.jpg'), "surface": 'CATALOG', "orderTitle": 'Sexo'}}, {contextInfo: { mentionedJid: [sender]}, quoted:choute, })
  leo.relayWAMessage(fansh)
  break
//════════════════════════════════════════ LOGOS ════════════════════════════════
  ...
  sendFileFromUrl(logo, image, {quoted: choute, caption: '*🔥Logos By Traxnox 🔥*\n*CANAL DEL CREADOR:*\nhttps://youtube.com/c/ByTraxnox', sendEphemeral: true})
  break
